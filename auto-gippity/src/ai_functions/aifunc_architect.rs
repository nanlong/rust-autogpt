...
pub fn print_project_scope(_project_description: &str) {
    ...
    ///     {
    ///         "is_curd_required": bool, // true if site needs CRUD functionality
...
pub fn print_site_urls(_project_description: &str) {
    ...
    /// Function: Outputs a list of external public API endpoints tat should be used in the building of the website
